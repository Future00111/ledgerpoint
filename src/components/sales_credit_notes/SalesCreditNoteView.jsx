...
export default function SalesCreditNoteView({ creditNote, open, onOpenChange }) {
      ...
      <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-3">
            ...
            <Badge variant="secondary" className={`text-xs ${statusColors[creditNote.status] || ''}`}>{creditNote.status}</Badge>
          </DialogTitle>
        </DialogHeader>
        <div className="space-y-4 py-2">
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              <p className="font-medium">{creditNote.original_invoice_number || '—'}</p>
            </div>
            <div>
