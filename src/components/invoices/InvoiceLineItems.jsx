    ...
    <div className="space-y-3">
      ...
      {lineItems.map((line, idx) => (
        <div key={idx} className="grid grid-cols-1 lg:grid-cols-12 gap-2 items-start">
          <Input className="lg:col-span-3" placeholder="Description" value={line.description} onChange={e => updateLine(idx, 'description', e.target.value)} />
          ...
          <Input className="lg:col-span-2" type="number" min="0" step="0.01" value={line.unit_price} onChange={e => updateLine(idx, 'unit_price', e.target.value)} />
