...
| # | Document | Purpose |
|---|----------|---------|
| 00 | [The Ledgerly Manifesto](./00-ledgerly-manifesto.md) | The guiding philosophy of the entire product. The highest-level document in Project Atlas — considered before Product Principles, PRD and Technical Architecture for every decision. |
