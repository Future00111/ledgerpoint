...
Whenever new functionality is created, it must comply with these principles.
...
AI should enhance decisions.
It should never override explicit business rules.
...
Every module must be searchable using Ask.
...
Users should not have multiple ways of completing the same task unless there is a clear benefit.

Ask should become the primary interaction point.
...
No single component should block the application.
...
Ledgerly may suggest.
Ledgerly may automate.
Ledgerly must never silently change accounting records.

Posting journals must always require approval where appropriate.
...
The application should feel like one product rather than separate modules.
...
Avoid looking like legacy accounting software.

---

## 16. Modular Architecture

Every feature should be capable of being extended without redesign.
...
Ledgerly should always increase customer confidence.
...
Every new feature should be accessible through Ask.

Users should never need to remember where functionality is located.
...
Every screen should be understandable by someone with little or no accounting knowledge.

Accountants should have access to advanced functionality without making the interface more complicated for everyone else.

---

## 20. Build For The Next Ten Years

When implementing features, avoid short-term solutions.

Database design, APIs, permissions, AI integrations and workflows should all be extensible.

Do not hardcode behaviour that limits future growth.
